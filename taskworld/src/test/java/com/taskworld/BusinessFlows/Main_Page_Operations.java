...
public class Main_Page_Operations extends Driver_Setup{
	...
	public void createNewProject() throws InterruptedException {
		...
		driver.findElement(By.name(Main_Page_Locators.project_name_input_field())).sendKeys("The sample project");
		driver.findElement(By.xpath(Main_Page_Locators.project_description_input_field())).sendKeys("The sample project description");
	...
	public void createNewTasklist() throws InterruptedException {
		...
		driver.findElement(By.xpath(Main_Page_Locators.enter_tasklist_name())).sendKeys("This is a TaskList");	// add task list name	and enter
	...
	public void createNewTask() throws InterruptedException {
		...
		driver.findElement(By.xpath(Main_Page_Locators.add_task_name_input_field())).sendKeys("This is Task");
	...
	public void completeOpenTask() throws InterruptedException {
		...
		driver.findElement(By.xpath(Main_Page_Locators.close_open_task_details())).click(); // close closed task details page
		Thread.sleep(5000);
	}
